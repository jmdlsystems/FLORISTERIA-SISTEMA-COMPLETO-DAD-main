  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          to="/sistemafloreria/proveedores/crear"
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {currentProveedores.map((proveedor) => (
              <tr key={proveedor.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{proveedor.contacto}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{proveedor.telefono}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{proveedor.direccion}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <div className="flex space-x-2">
                    <Link
                      to={`/sistemafloreria/proveedores/${proveedor.id}/actualizar`}
      ...
      <div className="mt-4 text-sm text-gray-600">
        Mostrando {indexOfFirstProveedor + 1} a {Math.min(indexOfLastProveedor, filteredProveedores.length)} de {filteredProveedores.length} proveedores
      </div>
    </div>
  );
};
