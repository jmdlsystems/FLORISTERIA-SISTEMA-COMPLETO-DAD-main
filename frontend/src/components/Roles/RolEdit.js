...
const RolEdit = () => {
  ...
  const loadRol = async () => {
    try {
      ...
      if (!response.success) {
        throw new Error(response.error || 'Error al cargar el rol');
      }
      ...
      setError('Error al cargar el rol: ' + err.message);
    } finally {
            ...
            <div className="mb-6">
              <div className="flex items-center">
                <input
                  ...
                  disabled={formData.nombre.trim().toUpperCase() === 'ADMINISTRADOR'}
                />
