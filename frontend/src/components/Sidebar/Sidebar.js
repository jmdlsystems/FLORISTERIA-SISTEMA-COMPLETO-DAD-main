  ...
  const menuItems = useMemo(() => {
    const baseItems = [
      { 
        ...
        route: '/sistemafloreria/dashboard',
    ...
    const adminItems = [
      { 
        ...
        route: '/sistemafloreria/usuarios',
        roles: ['ADMINISTRADOR']
      },
      { 
        label: 'Roles', 
        icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', 
        route: '/sistemafloreria/roles',
        roles: ['ADMINISTRADOR']
      },
      { 
        label: 'Productos', 
        icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', 
        route: '/sistemafloreria/productos',
        roles: ['ADMINISTRADOR']
      },
      { 
        label: 'Categorías', 
        icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', 
        route: '/sistemafloreria/categorias',
        roles: ['ADMINISTRADOR']
      },
      { 
        label: 'Proveedores', 
        icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', 
        route: '/sistemafloreria/proveedores',
        roles: ['ADMINISTRADOR']
      },
      { 
        label: 'Ubicaciones', 
        icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z', 
        route: '/sistemafloreria/ubicaciones',
        roles: ['ADMINISTRADOR']
      },
      { 
        label: 'Órdenes de Compra', 
        icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 
        route: '/sistemafloreria/ordenes-compra',
        roles: ['ADMINISTRADOR']
      }
    ];
    ...
    const inventoryItems = [
      { 
        label: '📊 Inventario', 
        icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', 
        route: '/sistemafloreria/inventario',
        isMain: true,
      ...
      { 
        ...
        route: '/sistemafloreria/ajustes-inventario',
        isAudit: true,
        roles: ['ADMINISTRADOR', 'FLORISTA']
      },
      { 
        ...
        route: '/sistemafloreria/movimientos',
        isAudit: true,
        roles: ['ADMINISTRADOR', 'FLORISTA']
      }
    ];
        ...
        <div className="flex items-center justify-between p-4 border-b">
          {!isCollapsed && (
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-semibold text-gray-800">Florería</span>
            </div>
          )}
          <button 
